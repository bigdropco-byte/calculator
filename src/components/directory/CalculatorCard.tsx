    ...
    return (
      ...
      >
        <div className="flex items-start sm:items-center gap-3.5 min-w-0">
          <div className="p-2 rounded-md bg-sky-50 text-sky-700 group-hover:bg-sky-600 group-hover:text-white transition-colors shrink-0">
            <CategoryIcon name={calculator.icon} className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h3 className="text-base font-semibold text-slate-900 group-hover:text-sky-700 transition-colors truncate">
                {calculator.name}
              </h3>
              {calculator.popular && (
        ...
        <div className="flex items-center justify-between sm:justify-end gap-3 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-100">
          <span className="text-xs text-slate-600 font-medium px-2.5 py-1 bg-slate-50 rounded-md border border-slate-200/80">
            {category?.shortName || calculator.category}
          </span>
          <span className="text-xs font-semibold text-sky-700 group-hover:translate-x-0.5 flex items-center gap-1 transition-transform">
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 mb-3">
        <div className="p-2 rounded-lg bg-sky-50 text-sky-700 group-hover:bg-sky-600 group-hover:text-white transition-colors">
          <CategoryIcon name={calculator.icon} className="w-5 h-5" />
        </div>
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-slate-600 font-medium px-2 py-0.5 rounded-md bg-slate-50 border border-slate-200">
            {category?.shortName || calculator.category}
          </span>
        </div>
      </div>

      <h3 className="text-base font-semibold text-slate-900 group-hover:text-sky-700 transition-colors line-clamp-1">
        {calculator.name}
      </h3>
